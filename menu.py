...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            item_number = input("Type menu item number: ")
            ...
            if item_number.isdigit():
                ...
                if item_number in menu_items.keys():
                    ...
                    print("That was not a valid menu item number.")
            else:
                # Tell the customer they didn't select a menu option
                print("You didn't type a menu option number.")
    ...
    while True:
        ...
        if keep_ordering.lower()in("y","yes") :
            ...
            break
                ...
                # their order
            print("Thank you for your order. We are working on it")
                # Exit the keep ordering question loop
            place_order = False
            break
        else:
...
for item in order_list:
    ...
    price_spaces = 7 - len(f"${item_price}")
